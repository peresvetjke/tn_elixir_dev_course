defmodule MyCalendarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MyCalendarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MyCalendarWeb.Gettext, "errors", msg, opts)
    end
  end
